...
class Reserver1 extends StatelessWidget {
  @override
...
class _formule extends State<formule> {
  ...
  final baseUrl =
      'https://93c3-102-180-6-244.ngrok-free.app/reservations/create/personne';
  int _nombrePlaces = 0;
  ...
  Future<void> fetchVille() async {
    final response = await http
        .get(Uri.parse('https://93c3-102-180-6-244.ngrok-free.app/api/ville/'));
        ...
        children: [
          Padding(
            ...
            child: TextFormField(
              ...
              onChanged: (value) {
                setState(() {
                  _nomEtPrenom = value.toString(); // Conversion en entier
                });
              },
            ),
          ),
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: Color.fromARGB(
                                255, 38, 14, 14), // changer la couleur en bleu
                          ),
                        ),
                        Padding(
